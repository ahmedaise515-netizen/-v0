const handler = async (m, { conn, text }) => {
    ...
    await conn.sendButton(m.chat, {
        ...
        mentions: [m.sender],
        newsletter: { name: "Aisa v1 🤡️", jid: "120363426553571462@newsletter" },
        interactiveConfig: { buttons_limits: 10, list_title: "Aisa v1 🤡 🎀", button_title: "AS ~ 3QAB 🎀", canonical_url: url }
    }, m);
};
